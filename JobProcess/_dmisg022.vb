...
Namespace SIS.DMISG
  ...
  Partial Public Class dmisg022
    ...
    '1 Used
    Public Shared Function InsertData(ByVal Record As SIS.DMISG.dmisg022, ByVal Comp As String) As SIS.DMISG.dmisg022
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spdmisg022" & Comp & "Insert"
    ...
    End Function
    '2. Used
    Public Shared Function Getdmisg022(ByVal t As vaultXML.Part, ByVal x As vaultXML, ByVal SrNo As Integer, ByVal pNo As Integer, ByVal pItem As String) As SIS.DMISG.dmisg022
      Dim tmp As New dmisg022
      With tmp
        .t_docn = x.drgid
        .t_revn = x.rev
        .t_srno = SrNo
