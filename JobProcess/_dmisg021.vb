...
Namespace SIS.DMISG
  ...
  Partial Public Class dmisg021
    ...
    End Class
    '1. Used
    Public Shared Function Getdmisg021(ByVal t As vaultXML.Item, ByVal x As vaultXML, ByVal SrNo As Integer) As SIS.DMISG.dmisg021
      Dim tmp As New dmisg021
      With tmp
        .t_docn = x.drgid
        .t_revn = x.rev
        .t_srno = SrNo
    ...
    '2. Used
    Public Shared Function InsertData(ByVal Record As SIS.DMISG.dmisg021, ByVal Comp As String) As SIS.DMISG.dmisg021
      If Record.Remarks <> "" Then
        Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetBaaNConnectionString())
          Using Cmd As SqlCommand = Con.CreateCommand()
            Cmd.CommandType = CommandType.StoredProcedure
            Cmd.CommandText = "spdmisg021" & Comp & "CreateText"
            SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@t_user", SqlDbType.VarChar, 240, "0340")
            SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@t_kwd1", SqlDbType.VarChar, 240, "dmisg021.txtb")
      ...
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spdmisg021" & Comp & "Insert"
